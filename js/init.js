...
var data = [
  {
    ...
    body: [
      {
        tag: "h4",
        content: "Metroresidences"
      },
      {
        tag: "p",
        content: "Implement UI from Design team"
      },
      {
        tag: "p",
        content: "Do UI Testing"
      },
      {
        tag: "p",
        content: "Optimize UI for production"
      },
      {
        tag: "p",
        content: "Techinical Environment: Reactjs, redux, thunk, react-routers"
      },
      {
        tag: "p",
  ...
  },
  {
    ...
    body: [
      ...
      {
        tag: "p",
        content: "Team Leader - Full Stack Developer"
      },
      {
        tag: "b",
        content: "Back-end"
      ...
      {
        tag: "li",
        content: "Initial Back-End Structure"
      },
      {
        tag: "li",
        content: "Design Database"
      },
      {
        tag: "li",
        content: "Design and build RestFull Api"
      },
      {
        tag: "li",
        content: "Implement schedule jobs"
      },
      {
        tag: "li",
        content: "Build streaming servers - prevent downloading"
      },
      {
        tag: "li",
        content: "Writing testable code, TDD"
      },
      {
        tag: "li",
        content: "Build Cache Server"
      },
      {
        tag: "li",
        content: "Build Continuous Integration and Continuous Delivery"
      },
      {
        tag: "li",
        content: "Scale application for production"
      },
      {
        tag: "li",
        content: "Implement RealTime services for Mobile Application"
      },
      {
        tag: "li",
        content:
          "Techinical Environment: RoR, Nodejs, Express, Angeda, Chai, Mocha, Docker, Nginx, Jenkins, MongoDB, PostgreSQL, Socket-IO"
      },
      {
        tag: "b",
        content: "Front-end"
      ...
      {
        tag: "li",
        content: "Initial Front-End Structure"
      },
      {
        tag: "li",
        content: "Implement UI from Design team"
  ...
  },
  {
    ...
    body: [
      ...
      },
      {
        tag: "li",
        content:
          "Techinical Environment: Nodejs, Express, Angeda, Chai, Mocha, Jenkins, MongoDB"
      },
      {
        tag: "b",
        content: "Front-end"
  ...
  },
  {
    ...
    body: [
      {
        tag: "h4",
        content: "Freelancer, Remote Jobs"
      },
      {
        tag: "p",
        content: "Full Stack Developer"
...
function arlo_tm_animate_text() {
  ...
  animateSpan.typed({
    strings: ["Mobile Developer", "Devops developer", "Web Developer"],
    loop: true,
    startDelay: 1e3,
    backDelay: 2e3
  });
